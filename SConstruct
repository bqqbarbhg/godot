...
opts.Add(EnumVariable("optimize", "Optimization type", "size", ("speed", "size", "none")))
opts.Add(BoolVariable("production", "Set defaults to build Godot for use in production", True))
opts.Add(BoolVariable("use_lto", "Use link-time optimization", True))
...
opts.Add(BoolVariable("disable_advanced_gui", "Disable advanced GUI nodes and behaviors", True))
