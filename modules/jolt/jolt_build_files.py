def get_files():
	dab = """
		...
		${JOLT_PHYSICS_ROOT}/Core/LockFreeHashMapJolt.h
		${JOLT_PHYSICS_ROOT}/Core/LockFreeHashMapJolt.inl
	...
	cpp_files = list(filter(lambda a: a.endswith(".cpp"), dab.split('\n')))
	thirdparty_sources = [file.replace("${JOLT_PHYSICS_ROOT}/", "").strip() for file in cpp_files]
