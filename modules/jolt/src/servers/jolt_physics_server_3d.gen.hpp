...
#ifndef JOLT_PHYSICS_SERVER_3D_GEN_HPP
#define JOLT_PHYSICS_SERVER_3D_GEN_HPP
...
class JoltPhysicsServer3D final : public PhysicsServer3D {
	GDCLASS_NO_WARN(JoltPhysicsServer3D, PhysicsServer3D)
public:
...
ObjectID body_get_object_instance_id(RID p_body) const override;
	...
	TypedArray<RID> _body_get_collision_exceptions(RID p_body) const;
	...
	TypedArray<RID> soft_body_get_collision_exceptions(RID p_body) const GDEX_OVERRIDE_EX_ONLY;
	...
	void soft_body_set_simulation_precision(RID p_body, int32_t p_simulation_precision)
		override;
	...
	void soft_body_set_linear_stiffness(RID p_body, real_t p_linear_stiffness) override;
	...
	void free_rid(RID p_rid) GDEX_OVERRIDE_EX_ONLY;
	...
	void soft_body_get_collision_exceptions(RID p_soft_body, List<RID> *p_exceptions) override {
		TypedArray<RID> ret = soft_body_get_collision_exceptions(p_soft_body);
	...
	bool body_test_motion(RID p_body, const MotionParameters &p_parameters, MotionResult *r_result = nullptr) override {
		...
		bool ret = body_test_motion(p_body, p_parameters.from, p_parameters.motion, p_parameters.margin, p_parameters.max_collisions, p_parameters.collide_separation_ray, p_parameters.recovery_as_collision, r_result);
...
#endif
#undef GDMODULE_IMPL
#endif // JOLT_PHYSICS_SERVER_3D_GEN_HPP