...
void JoltPhysicsServer3D::bind_methods() {
...
void JoltPhysicsServer3D::space_set_param(
	RID p_space,
...
void JoltPhysicsServer3D::space_set_debug_contacts(
...
void JoltPhysicsServer3D::area_add_shape(
	RID p_area,
	RID p_shape,
...
void JoltPhysicsServer3D::area_set_shape(
	RID p_area,
	int32_t p_shape_idx,
	RID p_shape
) {
...
void JoltPhysicsServer3D::area_set_shape_transform(
	RID p_area,
	int32_t p_shape_idx,
	const Transform3D& p_transform
) {
...
int32_t JoltPhysicsServer3D::area_get_shape_count(RID p_area) const {
	const JoltAreaImpl3D* area = area_owner.get_or_null(p_area);
	ERR_FAIL_NULL_D(area);
...
RID JoltPhysicsServer3D::area_get_shape(RID p_area, int32_t p_shape_idx) const {
	const JoltAreaImpl3D* area = area_owner.get_or_null(p_area);
	ERR_FAIL_NULL_D(area);
...
Transform3D JoltPhysicsServer3D::area_get_shape_transform(RID p_area, int32_t p_shape_idx)
	const {
	const JoltAreaImpl3D* area = area_owner.get_or_null(p_area);
	ERR_FAIL_NULL_D(area);
...
void JoltPhysicsServer3D::area_remove_shape(RID p_area, int32_t p_shape_idx) {
	JoltAreaImpl3D* area = area_owner.get_or_null(p_area);
	ERR_FAIL_NULL(area);
...
void JoltPhysicsServer3D::area_set_shape_disabled(
	RID p_area,
	int32_t p_shape_idx,
	bool p_disabled
) {
...
void JoltPhysicsServer3D::area_set_param(
	RID p_area,
...
void JoltPhysicsServer3D::area_set_monitor_callback(
	RID p_area,
...
void JoltPhysicsServer3D::area_set_area_monitor_callback(
	RID p_area,
	const Callable& p_callback
) {
	JoltAreaImpl3D* area = area_owner.get_or_null(p_area);
...
void JoltPhysicsServer3D::body_add_shape(
	RID p_body,
	RID p_shape,
	const Transform3D& p_transform,
	bool p_disabled
...
void JoltPhysicsServer3D::body_set_shape(
	RID p_body,
	int32_t p_shape_idx,
	RID p_shape
) {
...
void JoltPhysicsServer3D::body_set_shape_transform(
	RID p_body,
	int32_t p_shape_idx,
	const Transform3D& p_transform
) {
...
int32_t JoltPhysicsServer3D::body_get_shape_count(RID p_body) const {
	const JoltBodyImpl3D* body = body_owner.get_or_null(p_body);
	ERR_FAIL_NULL_D(body);
...
RID JoltPhysicsServer3D::body_get_shape(RID p_body, int32_t p_shape_idx) const {
	const JoltBodyImpl3D* body = body_owner.get_or_null(p_body);
	ERR_FAIL_NULL_D(body);
...
Transform3D JoltPhysicsServer3D::body_get_shape_transform(RID p_body, int32_t p_shape_idx)
	const {
	const JoltBodyImpl3D* body = body_owner.get_or_null(p_body);
	ERR_FAIL_NULL_D(body);
...
void JoltPhysicsServer3D::body_remove_shape(RID p_body, int32_t p_shape_idx) {
	JoltBodyImpl3D* body = body_owner.get_or_null(p_body);
	ERR_FAIL_NULL(body);
...
void JoltPhysicsServer3D::body_set_shape_disabled(
	RID p_body,
	int32_t p_shape_idx,
	bool p_disabled
) {
...
void JoltPhysicsServer3D::body_set_enable_continuous_collision_detection(
	RID p_body,
	bool p_enable
) {
	JoltBodyImpl3D* body = body_owner.get_or_null(p_body);
...
void JoltPhysicsServer3D::body_set_user_flags(
	[[maybe_unused]] RID p_body,
...
uint32_t JoltPhysicsServer3D::body_get_user_flags([[maybe_unused]] RID p_body) const {
	return 0;
}

void JoltPhysicsServer3D::body_set_param(
	RID p_body,
...
void JoltPhysicsServer3D::body_set_state(
	RID p_body,
	BodyState p_state,
	const Variant& p_value
) {
...
void JoltPhysicsServer3D::body_apply_impulse(
	RID p_body,
...
void JoltPhysicsServer3D::body_apply_force(
	RID p_body,
...
void JoltPhysicsServer3D::body_add_constant_central_force(
	RID p_body,
	const Vector3& p_force
) {
	JoltBodyImpl3D* body = body_owner.get_or_null(p_body);
...
void JoltPhysicsServer3D::body_add_constant_force(
	RID p_body,
	const Vector3& p_force,
	const Vector3& p_position
) {
...
void JoltPhysicsServer3D::body_set_axis_velocity(
	RID p_body,
...
void JoltPhysicsServer3D::body_add_collision_exception(
	RID p_body,
	RID p_excepted_body
) {
	JoltBodyImpl3D* body = body_owner.get_or_null(p_body);
...
void JoltPhysicsServer3D::body_remove_collision_exception(
	RID p_body,
	RID p_excepted_body
) {
	JoltBodyImpl3D* body = body_owner.get_or_null(p_body);
...
TypedArray<RID> JoltPhysicsServer3D::_body_get_collision_exceptions(RID p_body) const {
	const JoltBodyImpl3D* body = body_owner.get_or_null(p_body);
	ERR_FAIL_NULL_D(body);
...
void JoltPhysicsServer3D::body_set_max_contacts_reported(RID p_body, int32_t p_amount) {
	JoltBodyImpl3D* body = body_owner.get_or_null(p_body);
	ERR_FAIL_NULL(body);
...
int32_t JoltPhysicsServer3D::body_get_max_contacts_reported(RID p_body) const {
	const JoltBodyImpl3D* body = body_owner.get_or_null(p_body);
	ERR_FAIL_NULL_D(body);
...
void JoltPhysicsServer3D::body_set_contacts_reported_depth_threshold(
	[[maybe_unused]] RID p_body,
	[[maybe_unused]] real_t p_threshold
) {
	WARN_PRINT(
...
real_t JoltPhysicsServer3D::body_get_contacts_reported_depth_threshold(
	[[maybe_unused]] RID p_body
) const {
	return 0.0;
}
...
void JoltPhysicsServer3D::body_set_state_sync_callback(
	RID p_body,
...
void JoltPhysicsServer3D::body_set_force_integration_callback(
	RID p_body,
	const Callable& p_callable,
...
bool JoltPhysicsServer3D::body_test_motion(
	RID p_body,
...
void JoltPhysicsServer3D::soft_body_update_rendering_server(
	[[maybe_unused]] RID p_body,
...
void JoltPhysicsServer3D::soft_body_set_space(
	[[maybe_unused]] RID p_body,
	[[maybe_unused]] RID p_space
) {
	// SoftBody3D is not supported
...
RID JoltPhysicsServer3D::soft_body_get_space([[maybe_unused]] RID p_body) const {
	// SoftBody3D is not supported
	return {};
}

void JoltPhysicsServer3D::soft_body_set_mesh(
	[[maybe_unused]] RID p_body,
	[[maybe_unused]] RID p_mesh
) {
	// SoftBody3D is not supported
}

AABB JoltPhysicsServer3D::soft_body_get_bounds([[maybe_unused]] RID p_body) const {
	// SoftBody3D is not supported
	return {};
}

void JoltPhysicsServer3D::soft_body_set_collision_layer(
	[[maybe_unused]] RID p_body,
...
uint32_t JoltPhysicsServer3D::soft_body_get_collision_layer([[maybe_unused]] RID p_body
) const {
	// SoftBody3D is not supported
	return {};
}

void JoltPhysicsServer3D::soft_body_set_collision_mask(
	[[maybe_unused]] RID p_body,
...
uint32_t JoltPhysicsServer3D::soft_body_get_collision_mask([[maybe_unused]] RID p_body
) const {
	// SoftBody3D is not supported
	return {};
}

void JoltPhysicsServer3D::soft_body_add_collision_exception(
	[[maybe_unused]] RID p_body,
	[[maybe_unused]] RID p_body_b
) {
	// SoftBody3D is not supported
}

void JoltPhysicsServer3D::soft_body_remove_collision_exception(
	[[maybe_unused]] RID p_body,
	[[maybe_unused]] RID p_body_b
) {
	// SoftBody3D is not supported
...
TypedArray<RID> JoltPhysicsServer3D::soft_body_get_collision_exceptions(
	[[maybe_unused]] RID p_body
) const {
	// SoftBody3D is not supported
	return {};
...
void JoltPhysicsServer3D::soft_body_set_state(
	[[maybe_unused]] RID p_body,
...
Variant JoltPhysicsServer3D::soft_body_get_state(
	[[maybe_unused]] RID p_body,
	[[maybe_unused]] BodyState p_state
) const {
	// SoftBody3D is not supported
...
void JoltPhysicsServer3D::soft_body_set_transform(
	[[maybe_unused]] RID p_body,
...
void JoltPhysicsServer3D::soft_body_set_ray_pickable(
	[[maybe_unused]] RID p_body,
...
void JoltPhysicsServer3D::soft_body_set_simulation_precision(
	[[maybe_unused]] RID p_body,
...
int32_t JoltPhysicsServer3D::soft_body_get_simulation_precision([[maybe_unused]] RID p_body
) const {
	// SoftBody3D is not supported
	return {};
}

void JoltPhysicsServer3D::soft_body_set_total_mass(
	[[maybe_unused]] RID p_body,
	[[maybe_unused]] real_t p_total_mass
) {
	// SoftBody3D is not supported
}

real_t JoltPhysicsServer3D::soft_body_get_total_mass([[maybe_unused]] RID p_body) const {
	// SoftBody3D is not supported
	return {};
}

void JoltPhysicsServer3D::soft_body_set_linear_stiffness(
	[[maybe_unused]] RID p_body,
	[[maybe_unused]] real_t p_linear_stiffness
) {
	// SoftBody3D is not supported
}

real_t JoltPhysicsServer3D::soft_body_get_linear_stiffness([[maybe_unused]] RID p_body
) const {
	// SoftBody3D is not supported
	return {};
}

void JoltPhysicsServer3D::soft_body_set_pressure_coefficient(
	[[maybe_unused]] RID p_body,
	[[maybe_unused]] real_t p_pressure_coefficient
) {
	// SoftBody3D is not supported
}

real_t JoltPhysicsServer3D::soft_body_get_pressure_coefficient([[maybe_unused]] RID p_body
) const {
	// SoftBody3D is not supported
	return {};
}

void JoltPhysicsServer3D::soft_body_set_damping_coefficient(
	[[maybe_unused]] RID p_body,
	[[maybe_unused]] real_t p_damping_coefficient
) {
	// SoftBody3D is not supported
}

real_t JoltPhysicsServer3D::soft_body_get_damping_coefficient([[maybe_unused]] RID p_body
) const {
	// SoftBody3D is not supported
	return {};
}

void JoltPhysicsServer3D::soft_body_set_drag_coefficient(
	[[maybe_unused]] RID p_body,
	[[maybe_unused]] real_t p_drag_coefficient
) {
	// SoftBody3D is not supported
}

real_t JoltPhysicsServer3D::soft_body_get_drag_coefficient([[maybe_unused]] RID p_body
) const {
	// SoftBody3D is not supported
	return {};
}

void JoltPhysicsServer3D::soft_body_move_point(
	[[maybe_unused]] RID p_body,
...
Vector3 JoltPhysicsServer3D::soft_body_get_point_global_position(
	[[maybe_unused]] RID p_body,
	[[maybe_unused]] int32_t p_point_index
) const {
	// SoftBody3D is not supported
...
void JoltPhysicsServer3D::soft_body_remove_all_pinned_points([[maybe_unused]] RID p_body) {
	// SoftBody3D is not supported
}

void JoltPhysicsServer3D::soft_body_pin_point(
	[[maybe_unused]] RID p_body,
	[[maybe_unused]] int32_t p_point_index,
...
bool JoltPhysicsServer3D::soft_body_is_point_pinned(
	[[maybe_unused]] RID p_body,
	[[maybe_unused]] int32_t p_point_index
) const {
	// SoftBody3D is not supported
...
void JoltPhysicsServer3D::joint_make_pin(
	RID p_joint,
	RID p_body_a,
...
void JoltPhysicsServer3D::pin_joint_set_param(
	RID p_joint,
...
void JoltPhysicsServer3D::joint_make_hinge(
	RID p_joint,
	RID p_body_a,
...
void JoltPhysicsServer3D::joint_make_hinge_simple(
	[[maybe_unused]] RID p_joint,
	[[maybe_unused]] RID p_body_a,
...
void JoltPhysicsServer3D::hinge_joint_set_param(
	RID p_joint,
...
real_t JoltPhysicsServer3D::hinge_joint_get_param(RID p_joint, HingeJointParam p_param)
	const {
	const JoltJointImpl3D* joint = joint_owner.get_or_null(p_joint);
	ERR_FAIL_NULL_D(joint);
...
void JoltPhysicsServer3D::hinge_joint_set_flag(
	RID p_joint,
...
void JoltPhysicsServer3D::joint_make_slider(
	RID p_joint,
	RID p_body_a,
...
void JoltPhysicsServer3D::slider_joint_set_param(
	RID p_joint,
...
real_t JoltPhysicsServer3D::slider_joint_get_param(RID p_joint, SliderJointParam p_param)
	const {
	const JoltJointImpl3D* joint = joint_owner.get_or_null(p_joint);
	ERR_FAIL_NULL_D(joint);
...
void JoltPhysicsServer3D::joint_make_cone_twist(
	RID p_joint,
	RID p_body_a,
	const Transform3D& p_local_ref_a,
	RID p_body_b,
...
void JoltPhysicsServer3D::cone_twist_joint_set_param(
	RID p_joint,
...
real_t JoltPhysicsServer3D::cone_twist_joint_get_param(
	RID p_joint,
	ConeTwistJointParam p_param
) const {
	const JoltJointImpl3D* joint = joint_owner.get_or_null(p_joint);
...
void JoltPhysicsServer3D::joint_make_generic_6dof(
	RID p_joint,
	RID p_body_a,
	const Transform3D& p_local_ref_a,
	RID p_body_b,
...
void JoltPhysicsServer3D::generic_6dof_joint_set_param(
	RID p_joint,
	Vector3::Axis p_axis,
...
real_t JoltPhysicsServer3D::generic_6dof_joint_get_param(
	RID p_joint,
	Vector3::Axis p_axis,
	PhysicsServer3D::G6DOFJointAxisParam p_param
) const {
...
void JoltPhysicsServer3D::generic_6dof_joint_set_flag(
	RID p_joint,
	Vector3::Axis p_axis,
...
bool JoltPhysicsServer3D::generic_6dof_joint_get_flag(
	RID p_joint,
	Vector3::Axis p_axis,
	PhysicsServer3D::G6DOFJointAxisFlag p_flag
) const {
...
void JoltPhysicsServer3D::joint_set_solver_priority(RID p_joint, int32_t p_priority) {
	JoltJointImpl3D* joint = joint_owner.get_or_null(p_joint);
	ERR_FAIL_NULL(joint);
...
int32_t JoltPhysicsServer3D::joint_get_solver_priority(RID p_joint) const {
	const JoltJointImpl3D* joint = joint_owner.get_or_null(p_joint);
	ERR_FAIL_NULL_D(joint);
...
void JoltPhysicsServer3D::joint_disable_collisions_between_bodies(
	RID p_joint,
	bool p_disable
) {
	JoltJointImpl3D* joint = joint_owner.get_or_null(p_joint);
...
int32_t JoltPhysicsServer3D::get_process_info([[maybe_unused]] ProcessInfo p_process_info) {
	return 0;
}
...
int32_t JoltPhysicsServer3D::joint_get_solver_velocity_iterations(RID p_joint) {
	JoltJointImpl3D* joint = joint_owner.get_or_null(p_joint);
	ERR_FAIL_NULL_D(joint);
...
int32_t JoltPhysicsServer3D::joint_get_solver_position_iterations(RID p_joint) {
	JoltJointImpl3D* joint = joint_owner.get_or_null(p_joint);
	ERR_FAIL_NULL_D(joint);
...
real_t JoltPhysicsServer3D::hinge_joint_get_jolt_param(
	RID p_joint,
...
bool JoltPhysicsServer3D::hinge_joint_get_jolt_flag(RID p_joint, HingeJointFlagJolt p_flag)
	const {
	const JoltJointImpl3D* joint = joint_owner.get_or_null(p_joint);
	ERR_FAIL_NULL_D(joint);
...
real_t JoltPhysicsServer3D::slider_joint_get_jolt_param(
	RID p_joint,
...
bool JoltPhysicsServer3D::slider_joint_get_jolt_flag(RID p_joint, SliderJointFlagJolt p_flag)
	const {
	const JoltJointImpl3D* joint = joint_owner.get_or_null(p_joint);
	ERR_FAIL_NULL_D(joint);
...
real_t JoltPhysicsServer3D::cone_twist_joint_get_jolt_param(
	RID p_joint,
...
real_t JoltPhysicsServer3D::generic_6dof_joint_get_jolt_param(
	RID p_joint,
	Vector3::Axis p_axis,
