...
#ifndef JOLT_PHYSICS_DIRECT_BODY_STATE_3D_GEN_HPP
#define JOLT_PHYSICS_DIRECT_BODY_STATE_3D_GEN_HPP
...
class JoltPhysicsDirectBodyState3D final : public PhysicsDirectBodyState3D {
	GDCLASS_NO_WARN(JoltPhysicsDirectBodyState3D, PhysicsDirectBodyState3D)
...
#endif
#undef GDMODULE_IMPL
#endif // JOLT_PHYSICS_DIRECT_BODY_STATE_3D_GEN_HPP