...
public:
	typedef Eigen::Matrix<
			typename ArgType::Scalar, RowIndexType::SizeAtCompileTime,
			ColIndexType::SizeAtCompileTime,
			ArgType::Flags & Eigen::RowMajorBit ? Eigen::RowMajor : Eigen::ColMajor,
			RowIndexType::MaxSizeAtCompileTime, ColIndexType::MaxSizeAtCompileTime>
			MatrixType;
	indexing_functor_row_col(const ArgType &arg, const RowIndexType &row_indices,
...
Eigen::CwiseNullaryOp<
		indexing_functor_row_col<ArgType, RowIndexType, ColIndexType>,
		typename indexing_functor_row_col<ArgType, RowIndexType,
				ColIndexType>::MatrixType>
indexing_row_col(const Eigen::MatrixBase<ArgType> &arg,
...
public:
	typedef Eigen::Matrix<
			...
			ArgType::Flags & Eigen::RowMajorBit ? Eigen::RowMajor : Eigen::ColMajor,
			RowIndexType::MaxSizeAtCompileTime, ArgType::MaxColsAtCompileTime>
			MatrixType;
...
template <class ArgType, class RowIndexType>
Eigen::CwiseNullaryOp<
		indexing_functor_row<ArgType, RowIndexType>,
		typename indexing_functor_row<ArgType, RowIndexType>::MatrixType>
indexing_row(const Eigen::MatrixBase<ArgType> &arg,
		const RowIndexType &row_indices) {
	typedef indexing_functor_row<ArgType, RowIndexType> Func;
	typedef typename Func::MatrixType MatrixType;
	return MatrixType::NullaryExpr(row_indices.size(), arg.cols(),
			Func(arg.derived(), row_indices));
}
...
public:
	typedef Eigen::Matrix<typename ArgType::Scalar, IndexType::SizeAtCompileTime,
			1, Eigen::ColMajor, IndexType::MaxSizeAtCompileTime, 1>
			VectorType;
...
template <class ArgType, class IndexType>
Eigen::CwiseNullaryOp<
		indexing_functor_vector<ArgType, IndexType>,
		typename indexing_functor_vector<ArgType, IndexType>::VectorType>
indexing_vector(const Eigen::MatrixBase<ArgType> &arg,
