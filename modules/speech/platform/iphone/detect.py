...
def get_opts():
    return [
        ...
        (
            "IPHONEPATH",
            "the path to iphone toolchain",
            "/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain",
        ),
        ("IOS_SDK_VERSION", "The SDK version", "iPhoneOS"),
        (
            "IPHONESDK",
            "path to the iphone SDK",
            "/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/${IOS_SDK_VERSION}.sdk/",
        ),
...
def configure(env):
    ...
    env.Append(
        CPPFLAGS=["-DIPHONE_ENABLED", "-DUNIX_ENABLED", "-DGLES2_ENABLED", "-DGLES1_ENABLED", "-DMPC_FIXED_POINT"]
    )
